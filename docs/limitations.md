...
**Actions.** No `rclpy.action` equivalent. micro-ROS does not have them
...
**TF / `tf2`.** No transform broadcaster or listener. Publish
...
**Parameter persistence to flash.** Parameters are runtime-only; they reset on
