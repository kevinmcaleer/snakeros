...
.PHONY: help test unit integration cdr-diff rig-up rig-down rig-logs bench mpy clean
...
help:
	...
	@echo "make mpy          - cross-compile to .mpy"
...
mpy:
	@command -v mpy-cross >/dev/null || { echo "mpy-cross not installed: pip install mpy-cross"; exit 1; }
